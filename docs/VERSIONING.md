...
Published packages use semantic versioning. Protocol and schema versions are public contracts and
are versioned independently inside their payloads. Compatible additive changes increment the minor
