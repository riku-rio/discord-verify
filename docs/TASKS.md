...
Note: All Python environments should be managed using `uv`.
...
* [ ] All environments managed with `uv`.
...
* [ ] pnpm workspace (primary development).
...
* [ ] Supported `discord.py 2.x` versions (Python 3.10+).
...
DV-0402
→ DV-0600
→ DV-0601 (uv-based interpreter resolution)
→ DV-0603
→ DV-0610
→ DV-0621
→ DV-0630
